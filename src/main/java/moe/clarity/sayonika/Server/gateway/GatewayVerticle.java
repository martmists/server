/**
 * Copyright 2018 (c) Eric Zhao and the Sayonika Project Authors.
 * The following code is from the vertx microservice blueprint repository, licensed under Apache-2.0
 */

package moe.clarity.sayonika.Server.gateway;

import io.vertx.blueprint.microservice.account.Account;
import io.vertx.blueprint.microservice.account.AccountService;
import moe.clarity.sayonika.Server.RestAPIVerticle;
