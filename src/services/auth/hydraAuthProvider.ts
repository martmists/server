...
export default class HydraAuthProvider {
   ...
   public static rejectLoginRequest(challenge, body) {
       return this.put('login', 'reject', challenge, body);
   }

   public static getConsentRequest(challenge) {
       return this.get('consent', challenge);
   }

   public static acceptConsentRequest(challenge, body) {
     return this.put('consent', 'accept', challenge, body);
   }

   public static rejectConsentRequest(challenge, body) {
